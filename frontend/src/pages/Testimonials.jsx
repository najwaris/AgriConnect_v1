            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <h2 className="mt-4 text-3xl font-bold text-teal-600 sm:text-4xl xl:text-5xl font-pj">Our happy buyers say about us</h2>
                        <p className="max-w-2xl mt-4 text-xl text-gray-600 font-medium font-pj">Here are top reviews from buyers who have purchased from us:</p>
                    </div>
